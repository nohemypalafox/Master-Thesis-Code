...
class OptimalControlProblem(object):
    ...
    def __init__(self, t_0=0.0, t_f=20.0, dimension=4,
                 s_zero=1000.0, e_zero=100, i_zero=50,
    ...
    def set_parameters(self, t_0, t_f, b, d, c, e, g, a,
                       a_w, s_zero, e_zero, i_zero, r_zero,
                       n_zero):
        # Parameters for the test example
        self.t_0 = t_0
        self.t_f = t_f
    ...
    def lambda_rhs(self, x_k, u_k, lambda_k):
        ...
        rhs_li = - a_w + (lambda_i - lambda_e) * c * s + lambda_i * (g + a + d) + lambda_n * a
